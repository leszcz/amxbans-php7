          ...
          <td colspan="2">
            ...
            {if $ban_details_edits}
              ...
              <table width="100%" cellspacing="0" border="1">
                ...
                {foreach from=$ban_details_edits item=ban_details_edit}
                  <tr class="info">
                    <td nowrap>{$ban_details_edit.edit_time|date_format:"%Y-%m-%d"}</td>
                    <td nowrap>{$ban_details_edit.admin_nick}</td>
                    <td>{$ban_details_edit.edit_reason|bbcode2html}</td>
                  </tr>
                {/foreach}
              </table>
            {/if}
