{foreach from=$yesno_select item=foo}
{if $foo == "_YES"}
{$yesno_select.0 = $foo|lang}
{elseif $foo == "_NO"} 
{$yesno_select.1 = $foo|lang}
{/if}
{/foreach}
              ...
              <form method="POST">
                <table>
                  ...
                  <tr class="info">
                    ...
                    <td><select name="use_capture" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.use_capture}</select></td>
                  </tr>
                  <tr class="info">
                    ...
                    <td><select name="auto_prune" width="200" 
                      ...
                      {html_options output=$yesno_select values=$yesno_values selected=$vars.auto_prune}
                    </select></td>
                  </tr>
                ...
                <table>
                  ...
                  <tr class="info">
                    ...
                    <td><select name="use_comment" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.use_comment}</select></td>
                  </tr>
                  {if $vars.use_comment==1}
                  <tr class="info">
                    <td width="50%">{"_COMMENTUSERALLOWEDWRITE"|lang}</td>
                    <td><select name="comment_all" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.comment_all}</select></td>
                  </tr>
                  {else}
                ...
                <table>
                  ...
                  <tr class="info">
                    ...
                    <td><select name="use_demo" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.use_demo}</select></td>
                  </tr>
                  {if $vars.use_demo==1}
                  <tr class="info">
                    <td width="50%">{"_FILE_USERUPLOADALLOWED"|lang}</td>
                    <td><select name="demo_all" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.demo_all}</select></td>
                  </tr>
                  <tr class="info">
                ...
                <table>
                  ...
                  <tr class="info">
                    ...
                    <td><select name="show_comment_count" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.show_comment_count}</select></td>
                  </tr>
                  {else}
                  ...
                  <tr class="info">
                    ...
                    <td><select name="show_demo_count" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.show_demo_count}</select></td>
                  </tr>
                  {else}
                  ...
                  <tr class="info">
                    ...
                    <td><select name="show_kick_count" width="200">{html_options output=$yesno_select values=$yesno_values selected=$vars.show_kick_count}</select></td>
                  </tr>
                </table>
